...
def main():
    ...
    background_image_url = "https://images.unsplash.com/photo-1545586860-95d2040c1680?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxleHBsb3JlLWZlZWR8MjU1fHx8ZW58MHx8fHx8"
    st.markdown(
        f"""
        <style>
            .stApp {{
